...
class DensityExplorer(QMainWindow):
    ...
    Plots   (bottom): 3 rows (File 1, File 2, Diff), each with:
      ...
      - 1 slice viewer (imshow) with a colorbar for the selected type at current axis/index.
    ...
    def __init__(self):
        ...
        # Colorbar handles for slice axes (so we can remove/replace cleanly)
    ...
    def _compute_or_clear_diff(self):
        ...
        # Compute diff: File 2 − File 1 (so positive => increase)
    ...
    def _update_slice_plot(self, key):
        ...
        # Add colorbar next to this slice
